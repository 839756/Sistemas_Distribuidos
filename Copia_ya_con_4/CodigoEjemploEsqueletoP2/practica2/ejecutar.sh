...
ssh $USER@192.168.3.9 "cd ~/practica2/; go run barrera.go"
...
ssh $USER@${IPS[0]} "cd ~/practica2/cmd/lector; go run main.go 1"

# Iniciar el programa lector en 192.168.3.10:29120
ssh $USER@${IPS[1]} "cd ~/practica2/cmd/lector; go run main.go 2"

# Iniciar el programa escritor en 192.168.3.11:29120
ssh $USER@${IPS[2]} "cd ~/practica2/cmd/escritor; go run main.go 3"

# Iniciar el programa escritor en 192.168.3.12:29120
ssh $USER@${IPS[3]} "cd ~/practica2/cmd/escritor; go run main.go 4"