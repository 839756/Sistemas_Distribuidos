#!/bin/bash
    ...
    if cmp -s "cmd/lector/fichero_1.txt" "cmd/lector/fichero_2.txt" && cmp -s "cmd/lector/fichero_2.txt" "cmd/escritor/fichero_3.txt" && cmp -s "cmd/escritor/fichero_3.txt" "cmd/escritor/fichero_4.txt"; then
